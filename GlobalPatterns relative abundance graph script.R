...
GlobalPatterns = transform_sample_counts(GlobalPatterns, function(x) x/sum(x))

bar_abundance_rel_df = otu_abundance(GlobalPatterns, "Phylum", 12)
bar_abundance_rel_df$SampleType = factor(bar_abundance_rel_df$SampleType, 
...
sort(unique(bar_abundance_rel_df$Phylum)) 
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Alphaproteobacteria"] = "aAlphaproteobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Betaproteobacteria"] = "bBetaproteobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Gammaproteobacteria"] = "cGammaproteobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Deltaproteobacteria"] = "dDeltaproteobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Acidobacteria"] = "eAcidobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Actinobacteria"] = "fActinobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Bacteroidetes"] = "gBacteroidetes"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Cyanobacteria"] = "hCyanobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Firmicutes"] = "iFirmicutes"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Fusobacteria"] = "jFusobacteria"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Planctomycetes"] = "kPlanctomycetes"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Verrucomicrobia"] = "lVerrucomicrobia"
bar_abundance_rel_df$Phylum[bar_abundance_rel_df$Phylum == "Other"] = "mOther"

phyla = sort(unique(bar_abundance_rel_df$Phylum)) %>%
...
samps.plot.rel = {ggplot(bar_abundance_rel_df, aes(x = X.SampleID, y = Abundance, fill = Phylum)) +
